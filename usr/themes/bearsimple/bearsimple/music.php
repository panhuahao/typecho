...
<div class="pure-g" id="layout">
            <div class="pure-u-1 pure-u-md-<?php if(Bsoptions('site_style') == '1' || Bsoptions('site_style') == ''):?>3<?php endif;?><?php if(Bsoptions('site_style') == '2'):?>4<?php endif;?>-4">
               ...
               <?php if(Bsoptions('Diy') == true): ?><div class="ui <?php if(Bsoptions('postType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('postType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('postType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('postType') == "4"): ?>piled<?php endif; ?> segment" <?php if(Bsoptions('postradius')): ?>style="border-radius:<?php echo Bsoptions('postradius'); ?>px"<?php endif; ?>><?php endif; ?>
                    <h2><i class="music icon"></i> <?php $this->title() ?></h2>
  <?php if(!empty(Bsoptions('douban_music_note'))): ?> 
    <div class="ui segment">
  <i class="red heart icon"></i>
  <?php echo Bsoptions('douban_music_note');?>
</div>
<?php endif; ?>

<div class="ui secondary pointing menu">
    <?php if(getMusicTag()[0]):?>
  <a id="first" class="item active" data-tab="first"><?php echo getMusicTag()[0]; ?></a>
  <?php endif; ?>
  <?php if(getMusicTag()[1]):?>
  <a id="second" class="item" data-tab="second"><?php echo getMusicTag()[1]; ?></a>
    <?php endif; ?>
  <?php if(getMusicTag()[2]):?>
  <a id="third" class="item" data-tab="third"><?php echo getMusicTag()[2]; ?></a>
  <?php endif; ?>
</div>
<?php if(getMusicTag()[0]):?>
<div class="ui bottom attached tab active" data-tab="first">
    <div id="loading"  class="ui icon message" style="display:none">
  <i class="music loading icon"></i>
  <div class="content">
    <div class="header">
      正在获取中.....
    </div>
...
str += '<div class="ui fluid card" style="word-break:break-all;"><div class="blurring dimmable image"><div class="ui dimmer"><div class="content"><div class="center"><a class="ui inverted button" href="' + list[i]['url'] + '"<?php if(Bsoptions('Link_blank') == true):?> target="_blank"<?php endif; ?>>我也要听</a></div></div></div><img id="imga" <?php echo lazyload('auto');?> src="'+ list[i]['cover'].replace('http://','//') +'"  data-src="'+ list[i]['cover'].replace('http://','//') +'" referrerPolicy="no-referrer"></div><div class="content" style="text-align:center;"><a class="header" href="' + list[i]['url'] + '"<?php if(Bsoptions('Link_blank') == true):?> target="_blank"<?php endif; ?>>《' + list[i]['title'] + '》</a><div class="meta"><a>歌手：' + list[i]['singer'] + '</a></div><div class="ui star rating" data-rating="' + list[i]['rating'] + '" data-max-rating="5" style="pointer-events: none;' + style + '"></div></div></div>'
}
